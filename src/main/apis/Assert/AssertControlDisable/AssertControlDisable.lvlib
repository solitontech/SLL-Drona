...
<Library LVVersion="16008000">
	...
	<Item Name="AssertControlDisable[Poly].vi" Type="VI" URL="../../AssertControlDisable[Poly].vi"/>
	<Item Name="AssertDisabled.vi" Type="VI" URL="../AssertDisabled.vi"/>
	<Item Name="AssertDisabledAndGrayedOut.vi" Type="VI" URL="../AssertDisabledAndGrayedOut.vi"/>
	<Item Name="AssertEnabled.vi" Type="VI" URL="../AssertEnabled.vi"/>
