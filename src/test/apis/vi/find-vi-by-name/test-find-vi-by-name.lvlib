...
<Library LVVersion="16008000">
	...
	<Item Name="helper" Type="Folder">
		<Item Name="test-vi-1-validate.vi" Type="VI" URL="../helper/test-vi-1-validate.vi"/>
		<Item Name="test-vi-1.vi" Type="VI" URL="../helper/test-vi-1.vi"/>
	</Item>
	<Item Name="current-instance.vi" Type="VI" URL="../current-instance.vi"/>
	<Item Name="project-instance.vi" Type="VI" URL="../project-instance.vi"/>
</Library>
